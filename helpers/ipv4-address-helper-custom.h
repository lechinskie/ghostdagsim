 ...
 * global problem.  Ipv4AddressHelperCustom is a simple class to make simple
...
public:
  ...
  Ipv4AddressHelperCustom(Ipv4Address network, Ipv4Mask mask,
                          bool checkAddressDuplication = true,
...
private:
  ...
  bool m_checkAddressDuplication; //!< disable or enable checking of address
                                  //!< duplication (Ipv4AddressGenerator),
                                  //!< default value = true
};
