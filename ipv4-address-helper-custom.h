...
class Ipv4AddressHelperCustom
{
  public:
     ...
     */
    Ipv4AddressHelperCustom(Ipv4Address network,
                            Ipv4Mask mask,
  ...
  private:
    ...
    bool m_checkAddressDuplication; //!< disable or enable checking of address duplication
                                    //!< (Ipv4AddressGenerator), default value = true
};
